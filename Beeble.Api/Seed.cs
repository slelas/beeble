        ...
        public static void Execute()
        {
            using (var context = new AuthContext())
            {
                ...
                if (!context.Users.Any())
                {
                    ...
                    for (var i = 0; i < 12; i++)
                    {
                        var numberOfBorrowedBooksInMonth = random.Next(55, 250);
                        var numberOfReservedBooksInMonth = random.Next(55, 250);

                        for (var j = 0; j < numberOfReservedBooksInMonth; j++)
                        {
                            listOfAllReservedBooks.Add(
                                new ReservedBooksAll()
                                {
                                    LocalLibrary = localLibrary1,
                                    TimeStamp = new DateTime(2016, 12, 9).AddMonths(-i)
                                });
                            ...
                            listOfAllReservedBooks.Add(
                                ...
                                {
                                    LocalLibrary = localLibrary1,
                                    TimeStamp = new DateTime(2018, 2, 9).AddMonths(-i)
                                });
                            ...
                            listOfAllReservedBooks.Add(
                                ...
                                {
                                    LocalLibrary = localLibrary1,
                                    TimeStamp = new DateTime(2017, 12, 9).AddMonths(-i)
                                });
                        }

                        for (var j = 0; j < numberOfBorrowedBooksInMonth; j++)
                        {
